...
public class MultipleFormalParamDeclarations extends FormPars {

    private FormPars FormPars;
    private FormalParamDecl FormalParamDecl;

    public MultipleFormalParamDeclarations (FormPars FormPars, FormalParamDecl FormalParamDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MultipleFormalParamDeclarations(\n");
