...
public class MultipleActualParams extends ActualParamList {

    private ActualParamList ActualParamList;
    private Expr Expr;

    public MultipleActualParams (ActualParamList ActualParamList, Expr Expr) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MultipleActualParams(\n");
